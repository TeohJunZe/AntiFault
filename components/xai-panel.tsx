      ...
      <div className="bg-muted/20 rounded-xl p-5 border border-border/50 shadow-sm relative flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto pr-2 space-y-6 text-base text-foreground/80 leading-relaxed">
          ...
          <section>
            ...
            <p>
              The monitored asset <strong className="text-foreground">{machineId}</strong> is currently operating with an estimated Remaining Useful Life (RUL) of <strong className="text-foreground">{(predicted_rul || 0).toFixed(2)} cycles</strong>, indicating {degradationStage}. The system has identified a <strong className="text-foreground">{(risk_level || 'unknown').toUpperCase()}</strong>-risk condition based on anomaly detection metrics.
            </p>
          </section>
      ...
      >
        ...
        <div style={{ fontSize: '17px', lineHeight: '1.6' }}>
          ...
          <p style={{ margin: 0 }}>
            ...
            (RUL) of {(predicted_rul || 0).toFixed(2)} cycles, indicating {degradationStage}. The system has identified a<br/>
            {risk_level || 'unknown'}-risk condition based on anomaly detection metrics.
          </p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={{ padding: '8px 0' }}>{risk_level ? (risk_level.charAt(0).toUpperCase() + risk_level.slice(1)) : 'N/A'}</td>
                </tr>
              </tbody>
            </table>
          </div>
