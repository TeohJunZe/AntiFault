...
from main import load_production_core, InferenceRequest, predict_rul
...
def build_degraded_history(factor):
    """
    Simulates REALISTIC degradation over 40 flight cycles.
    Instead of flatlining, the sensors actively degrade along a slope.
    """
    history = []
    ...
    for i in range(40):
        ...
        # The slope increases as we approach the 40th frame
        # We use a tiny base multiplier (0.001) to stay within realistic CMAPSS physics
        time_progression = (i / 39.0) 
...
async def build_mocks():
    print("Initializing local Production Core...")
