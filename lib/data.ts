...
export const mockMachines: Machine[] = [
  ...
  },
  {
    ...
    components: [
      { id: 'm3-motor',    name: 'Motor Assembly',   status: 'degraded', health: 78, lastMaintenance: '2025-12-01', predictedFailure: null,         position: [0.8, 0, 0]  as [number, number, number], repairTime: 6, replacementCost: 22000, contributionToRUL: 5  },
      { id: 'm3-coupling', name: 'Coupling',          status: 'healthy',  health: 82, lastMaintenance: '2025-12-01', predictedFailure: null,         position: [0.4, 0, 0]  as [number, number, number], repairTime: 2, replacementCost: 3500,  contributionToRUL: 5  },
      { id: 'm3-bearing',  name: 'Bearing Assembly',  status: 'degraded', health: 45, lastMaintenance: '2025-12-01', predictedFailure: '2026-04-25', position: [0, 0.3, 0]  as [number, number, number], repairTime: 3, replacementCost: 5000,  contributionToRUL: 20 },
      { id: 'm3-casing',   name: 'Pump Casing',       status: 'degraded', health: 75, lastMaintenance: '2025-12-01', predictedFailure: null,         position: [0, 0, 0]    as [number, number, number], repairTime: 4, replacementCost: 12000, contributionToRUL: 5  },
      { id: 'm3-rotor',    name: 'Rotor Assembly',    status: 'failing',  health: 22, lastMaintenance: '2025-12-01', predictedFailure: '2026-04-23', position: [0, -0.3, 0] as [number, number, number], repairTime: 5, replacementCost: 18000, contributionToRUL: 40 },
      { id: 'm3-sealing',  name: 'Sealing System',    status: 'failing',  health: 38, lastMaintenance: '2025-12-01', predictedFailure: '2026-04-28', position: [-0.2, 0, 0] as [number, number, number], repairTime: 2, replacementCost: 4000,  contributionToRUL: 15 },
      { id: 'm3-wear',     name: 'Wear Parts',        status: 'failing',  health: 30, lastMaintenance: '2025-12-01', predictedFailure: '2026-04-26', position: [-0.5, 0, 0] as [number, number, number], repairTime: 1, replacementCost: 2000,  contributionToRUL: 10 },
    ],
